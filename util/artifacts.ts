export class Artifacts {
  ...
  constructor(artifacts: any) {
    ...
    this.LicenseCoreTest = artifacts.require(
      'LicenseCoreTest'
    );
    this.LicenseSale = artifacts.require('LicenseSale');
    this.LicenseOwnership = artifacts.require(
      'LicenseOwnership'
    );
    this.LicenseInventory = artifacts.require(
      'LicenseInventory'
    );
    this.LicenseBase = artifacts.require('LicenseBase');
    this.LicenseAccessControl = artifacts.require(
